<!-- src/lib/components/ResearchProducts.svelte -->
<script lang="ts">
  import {
    Card,
    CardContent,
...
<Card
  class="border-2 border-black dark:border-dark-border shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] dark:shadow-[4px_4px_0px_0px_rgba(44,46,51,0.1)] w-full"
>
  <CardHeader>
