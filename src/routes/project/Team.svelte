<!-- src/routes/project/Team.svelte -->
<script lang="ts">
  import {
    Card,
    CardContent,
...
<div class="container mx-auto py-6 px-4">
  <div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl font-bold">Project Team</h1>
    <Button class="">
  ...
  <div class="grid gap-6">
    ...
    >
      <CardHeader>
        <CardTitle class="">Team Members</CardTitle>
      </CardHeader>
      <CardContent>
        <p class="text-muted-foreground">
          No team members added yet. Start by inviting researchers to your
          project.
        </p>
      </CardContent>
    </Card>
    ...
    >
      <CardHeader>
        <CardTitle class="">Pending Invites</CardTitle>
      </CardHeader>
      <CardContent>
