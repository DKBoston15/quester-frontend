...
<div class="container mx-auto py-6 px-4">
  <div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl font-mono font-bold">Research Notes</h1>
  ...
  <div class="mb-6">
    <Input type="text" placeholder="Search notes..." class="font-mono" />
  </div>
  ...
  <div class="grid gap-6">
    ...
    >
      <CardHeader>
        <CardTitle class="font-mono">No notes yet</CardTitle>
      </CardHeader>
      <CardContent>
